...
- Aim for 85% line coverage per crate. CI tracks coverage with `cargo llvm-cov nextest`; meaningful drops should be
...
**Pull request descriptions** should be the main "what changed / why" content only. Cover the behavior change,
...
Code and documentation in this repository are dual-licensed under MIT OR Apache-2.0 unless a specific file says
otherwise.
